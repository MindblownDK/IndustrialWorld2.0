...
| Fluids / gases | 🛠️ WORKING ON | Pipe-gated transfer exists. **7.8.1-dev** hardens dense grid/ground pipe performance; **7.9.0-dev** restores up-to-five-small-cell same-plane runs while retaining strict off-plane rejection and conduit-volume placement protection. Unity validation is pending. |
