...
| Water simulation | 🛠️ WORKING ON | **7.11.0-dev** removes the external ocean integration in favour of native curved spherical ocean rendering, voxel pools/lakes, radial wakes, finite/infinite pool pumping, pipe-aware buffers, and dense slow-sinking crude. Unity validation is pending. |
