...
| UI / UX | 🛠️ WORKING ON | Runtime crisp UI scaling, responsive machine panels, build-wheel fit, recipe validation tooling, drop-limit notifications, inventory-weight readout, and terminal search are active. **7.6.0-dev** adds premium bottom-left and cockpit gravity-pull telemetry; Unity validation remains required. |
