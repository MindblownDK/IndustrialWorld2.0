...
| Camera / trajectory tools | 🛠️ WORKING ON | Basic camera foundations exist. **7.8.0-dev** adds a cockpit coast-path orbital solver/readout for tangential versus circular velocity and periapsis/apoapsis diagnostics; Unity validation, trajectory rendering, zoom-to-trajectory, and orbit-map controls remain open. |
