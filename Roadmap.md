...
| Mythical enemies / bosses | 🚧 IN PROGRESS | **6.41.x:** Ghoul. **6.45.0:** Manticore (spikes + poison). **6.46.0:** Griffin (flying dive-bomb). **6.47.0:** Karkadann (charge + frontal armor). **6.48.0-dev:** Ifrit Djinn (fireballs + teleport + fire walls + burn). Roc, Leviathan, and Basilisk-class encounters remain. |
