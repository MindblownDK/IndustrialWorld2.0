...
| Mythical enemies / bosses | 🚧 IN PROGRESS | **6.41.x:** Ghoul. **6.45.0-dev:** Manticore (tail-spike volley + armor-bypassing poison). Griffin, Roc, Karkadann, Ifrit Djinn, Leviathan, and Basilisk-class encounters remain. |
