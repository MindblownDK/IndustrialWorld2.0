...
| Crafting / items / storage | 🛠️ WORKING ON | Core systems exist. **6.16.0-dev** adds global 900-unit matter stacks, player/container weight limits, matter-conversion storage GB usage, and inventory-weight UI. **7.10.0-dev** adds the Pirate Jack Pump Head relic, Tier-4 Pirate Oil Recovery research, expensive 90-second Jack Pump crafting, and infinite-node barrel extraction; deeper recipe chains and storage progression remain open. |
