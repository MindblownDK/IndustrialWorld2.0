    ...
    public class WaterPipe : FluidNode
    {
        ...
        private List<Vector3> GetNeighbourPositions()
        {
            ...
            if (grid != null)
            {
                ...
                void AddArm(VoxelEngine.GridSystem.GridBlock block)
                {
                    ...
                    if (connectedPipe)
                    {
                        ...
                        if (!VoxelEngine.Networks.PipeAdjacency.IsBendablePipeLinkDelta(localDelta, detail, 5f, detail * 0.18f)) return;
            ...
            else
            {
                ...
                // bounded orthogonal riser; three-axis diagonals remain excluded.
