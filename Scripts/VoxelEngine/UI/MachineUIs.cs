...
public static VisualElement QuarryPanel(Quarry q, SlotBuilder slot)
        {
            ...
            p.Add(T.Spacer(8));
            p.Add(T.Muted("Drop Quarry Upgrades into the slots on the left. Connect item pipes to export."));
            return p;
        }
        ...
        private static VisualElement QBadge(string txt, Color accent)
        {
            ...
            b.Add(l);
            return b;
        }sets/Scripts/VoxelEngine/UI/MachineUIs.cs
//
// ╔══════════════════════════════════════════════════════════════════╗
// ║      MACHINE UI PANELS — All in-game machines, unified theme   ║
// ║   Each panel: icon badge + header + accent divider + content.  ║
...
//                        QUARRY
// ════════════════════════════════════════════════════════════
/Scripts/VoxelEngine/UI/MachineUIs.cs
//
// ╔══════════════════════════════════════════════════════════════════╗
// ║      MACHINE UI PANELS — All in-game machines, unified theme   ║
// ║   Each panel: icon badge + header + accent divider + content.  ║
